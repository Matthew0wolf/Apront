    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] bg-card">
        ...
        <div className="grid gap-6 py-4 max-h-[70vh] overflow-y-auto px-2">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="presenter_notes" className="text-right">Notas (Apresentador)</Label>
            <Textarea id="presenter_notes" value={editedItem.presenter_notes || ''} onChange={(e) => handleChange('presenter_notes', e.target.value)} className="col-span-3" placeholder="Notas privadas para o apresentador..." rows={3} />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
